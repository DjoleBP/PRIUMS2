...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButtonON.setText(_translate("MainWindow", "SERIAL ON"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.tabTerminal), _translate("MainWindow", "Terminal"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.tabPlot), _translate("MainWindow", "Plot"))
        self.pushButtonOFF.setText(_translate("MainWindow", "SERIAL OFF"))
