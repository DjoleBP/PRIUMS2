...
class MyForm(QMainWindow):
    def __init__(self):
        ...
        # Podesavanje tastera (UART/Settings/Start/Open)
        self.ui.actionStart.setEnabled(False)
        self.ui.actionStop.setEnabled(False)

        self.ui.actionSettings.triggered.connect(self.configure)
    ...
    def open_com(self):
        ...
        self.ui.pushButtonON.clicked.connect(self.com_thread.serial_ON)
        self.ui.pushButtonOFF.clicked.connect(self.com_thread.serial_OFF)
